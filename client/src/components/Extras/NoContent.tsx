  ...
  return (
    <div>
      <div className="subredditvars-r-whitepeopletwitter">
        <div className="_1nxEQl5D2Bx2jxDILRHemb   " aria-hidden="false">
          <div className="TbMmDiSaSaBQFF9F3FGe8 _2ze7IsXK_2d3McYZHK6v_D">
            <div className="TbMmDiSaSaBQFF9F3FGe8">
              <svg
                className="_2AxaYiv6EkZse5msRZqowQ"
                viewBox="0 0 24 21"
