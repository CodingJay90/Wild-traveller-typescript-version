      ...
      <div className="deck">
        <div className="card">
          <header className="cardHeader">
            ...
            <span className="cardHeader_account">@hongkongfp</span>
            <span className="cardHeader_date">Jul 1 6:03</span>
          </header>
          <div className="cardBody">
            <p className="cardText">
              On Tuesday, China’s National People’s Congress Standing Committee
              unanimously passed a controversial national security law for Hong
              Kong. The law, which criminalises acts of secession, subversion,
              foreign interference and terrorism, was promulgated and gazetted
              on the same day with immediate effect. Details were only revealed
              late at night as it was directly inserted into the Annex III of
              the semi-autonomous region’s mini-constitution, bypassing the
              local legislature.
              <span className="cardText_highlight">#hongkong</span>{" "}
              <span className="cardText_highlight">#china</span>{" "}
              <span className="cardText_highlight">#humanrights</span>{" "}
              <span className="cardText_highlight">#hk</span>
            </p>
            <section className="cardStats">
              <span className="cardStats_stat cardStats_stat-likes">
                2155 <i className="far fa-heart fa-fw"></i>
              </span>
              <span className="cardStats_stat cardStats_stat-comments">
                87 <i className="far fa-comment fa-fw"></i>
              </span>
            </section>
          </div>
        </div>
        ...
        <div className="card">
          <header className="cardHeader">
            ...
            <span className="cardHeader_account">@hongkongfp</span>
            <span className="cardHeader_date">Jul 2 11:49</span>
          </header>
          <div className="cardBody">
            <p className="cardText">
              “Liberate Hong Kong; revolution of our times,” is
              pro-independence, secessionist or subversive, and thus
              criminalised under the newly-enacted national security law, the
              government says. Law scholar Benny Tai said: "The reality is,
              under the Hong Kong national security law, every sentence said by
              every person at every moment could touch the red line and be said
              as violating the law. How could the national security law only
              targets a small group of people.”
            </p>
            <section className="cardStats">
              <span className="cardStats_stat cardStats_stat-likes">
                857 <i className="far fa-heart fa-fw"></i>
              </span>
              <span className="cardStats_stat cardStats_stat-comments">
                54 <i className="far fa-comment fa-fw"></i>
              </span>
              <span className="cardStats_stat cardStats_stat-shares">
                410 <i className="far fa-share fa-fw"></i>
              </span>
            </section>
          </div>
        </div>
        ...
        <div className="card">
          <header className="cardHeader">
            ...
            <span className="cardHeader_account">@hongkongfp</span>
            <span className="cardHeader_date">Jul 6 11:26</span>
          </header>
          <div className="cardBody">
            <p className="cardText">
              Hong Kong gov’t tells schools to remove books breaching security
              law
              <span className="cardText_highlight">
                https://t.co/JbyrMwxexU
              </span>
            </p>
            <section className="cardStats">
              <span className="cardStats_stat cardStats_stat-likes">
                96 <i className="far fa-heart fa-fw"></i>
              </span>
              <span className="cardStats_stat cardStats_stat-retweets">
                110 <i className="far fa-retweet fa-fw"></i>
              </span>
            </section>
          </div>
        </div>
